import { jsx as v, jsxs as j, Fragment as Me } from "react/jsx-runtime";
...
import { c as re, e as ee, g as ze, u as _e, S as Ee, b as Ne, T as je, d as te, f as b, a as ne } from "../../../chunks/Slider.module.css.js";
import { u as Ue } from "../../../chunks/use-uncontrolled.js";
function Be(u) {
...
const Ke = Pe(
  ...
  const m = Ve("RangeSlider", Xe, u), {
    ...
    varsResolver: Ke,
    unstyled: ue
  }), { dir: L } = Ie(), [_, H] = Z(-1), [X, $] = Z(!1), [o, ge] = Ue({
    value: d,
    defaultValue: z,
    finalValue: [a, s],
    onChange: I
  ...
  return /* @__PURE__ */ v(Ee, { value: { getStyles: he }, children: /* @__PURE__ */ j(Ne, { ...me, size: V, ref: n, disabled: C, children: [
    /* @__PURE__ */ j(
      je,
      {
        offset: A[0],
