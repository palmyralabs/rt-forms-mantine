...
declare const MantineServerLookup: import('react').ForwardRefExoticComponent<IServerLookupDefinition & AutocompleteProps & import('react').RefAttributes<IServerLookupField>>;
