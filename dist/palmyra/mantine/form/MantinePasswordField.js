...
const Ve = {
  ...
  const o = Ce("PasswordInput", Ve, c), {
    ...
    vars: g,
    varsResolver: Me
  }), { resolvedClassNames: b, resolvedStyles: _ } = we({
    classNames: a,
    styles: f,
    props: o
    ...
    z.Wrapper,
    {
      ...
      children: /* @__PURE__ */ s(
        z,
        {
          ...
          leftSection: p,
          size: V,
          classNames: { ...b, input: ge(I.input, b.input) },
          styles: _,
          radius: M,
          disabled: r,
          __staticSelector: "PasswordInput",
...
S.classes = { ...be.classes, ...I };
S.displayName = "@mantine/core/PasswordInput";
const We = re(function(e, o) {
  const a = ce(e.attribute, e), { getError: h, getValue: m, setValue: f, mutateOptions: i } = a, g = o || R(null), C = h(), n = R(null), p = e.variant || "default";
  le(g, () => ({
    ...de(a),
    focus() {
      n.current.focus();
  ...
  return r.onChange = (d) => {
    e.readOnly || (f(d.target.value), e.onChange && e.onChange(d));
