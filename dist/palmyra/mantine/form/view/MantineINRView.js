import { jsxs as o, Fragment as f, jsx as n } from "react/jsx-runtime";
...
import { formatAmount as g } from "../../FormatCurrency.js";
import { getFieldLabel as G } from "../util.js";
import { getVariantClassName as b } from "./variantClassName.js";
...
const Q = A(function(e, c) {
  ...
  const h = /* @__PURE__ */ o(f, { children: [
    /* @__PURE__ */ n(W, { label: r ? "Switch to Digits" : "Switch to Words", withArrow: !0, children: /* @__PURE__ */ n("div", { onClick: M, style: { cursor: "pointer" }, children: r ? /* @__PURE__ */ n(Z, {}) : /* @__PURE__ */ n(L, {}) }) }),
    /* @__PURE__ */ o("div", { style: { display: "flex", alignItems: "center" }, children: [
      /* @__PURE__ */ n(S, {}),
      r ? R(u) : g(u)
    ] })
  ] });
  return /* @__PURE__ */ n(f, { children: !F.visible && /* @__PURE__ */ n(
    H,
    {
      label: G(e),
      ...
      children: e.label ? /* @__PURE__ */ o("div", { ...m, className: "text-view-field-container", children: [
        ...
        /* @__PURE__ */ n("div", { className: b(d, e.label), style: {
          display: "flex",
          alignItems: "center",
          justifyContent: "space-between",
          padding: "0 10px"
        }, children: h })
      ] }) : /* @__PURE__ */ n("div", { ...m, style: { textAlign: C }, children: /* @__PURE__ */ n("div", { className: b(d, e.title), style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "space-between",
        padding: "0 10px"
