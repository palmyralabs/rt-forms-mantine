...
const Q = T(function(e, c) {
  const r = V(e.attribute, e), { getValue: F, mutateOptions: g } = r, w = c || x(null), C = e.textAlign || "left", N = x(null), d = e.variant || "standard", y = e.valueFormat || "text";
  j(w, () => ({
    ...H(r),
    focus() {
      N.current.focus();
  ...
  var m = r.getFieldProps();
  const f = /* @__PURE__ */ o(h, { children: [
    /* @__PURE__ */ l($, { label: s ? "Switch to Digits" : "Switch to Words", withArrow: !0, children: /* @__PURE__ */ l("div", { onClick: M, style: { cursor: "pointer" }, children: s ? /* @__PURE__ */ l(Z, {}) : /* @__PURE__ */ l(S, {}) }) }),
    /* @__PURE__ */ o("div", { style: { display: "flex", alignItems: "center" }, children: [
      /* @__PURE__ */ l(G, {}),
      s ? R(u) : b(u, e.maxFraction)
    ] })
  ] });
  return /* @__PURE__ */ l(h, { children: !g.visible && /* @__PURE__ */ l(
    A,
    {
      label: W(e),
