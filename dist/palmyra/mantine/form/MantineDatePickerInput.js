...
const T = P(function(e, i) {
  const u = e.valueFormat || L(), m = e.type, { parse: h, format: v, revert: f } = S(e), c = B(e.attribute, e, { format: v, parse: h }), { getError: d, getValue: g, setValue: a, mutateOptions: C, refreshError: E } = c, F = i || s(null), b = d(), z = g(), y = s(null);
  M(F, () => ({
    ...H(c),
    focus() {
      y.current.focus();
