...
const K = I(function(e, i) {
  const m = e.valueFormat || "YYYY-MM-DD", u = e.type, { parse: h, format: v, revert: f } = x(e), c = H(e.attribute, e, { format: v, parse: h }), { getError: d, getValue: g, setValue: n, mutateOptions: C, refreshError: j } = c, F = i || s(null), b = d(), z = g(), y = s(null);
  R(F, () => ({
    ...P(c),
    focus() {
      y.current.focus();
  ...
  r.onChange = (t) => {
    e.readOnly || (u == "range" ? n(t ? [l(t[0]), l(t[1])] : void 0) : n(t ? l(t) : void 0), e.onChange && e.onChange(t));
  }, r.onBlur = (t) => {
    e.onBlur && e.onBlur(t);
  };
  const D = f(z), M = e.rightSection ? e.rightSection : /* @__PURE__ */ a(S, {});
