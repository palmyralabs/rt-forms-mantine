...
import { t as Yt, b as _, d as ce, B as G, g as Pe, i as Oe, n as rt, c as le, k as Wt, l as W, f as O, h as jt } from "../../chunks/factory.js";
import { u as Ie } from "../../chunks/use-resolved-styles-api.js";
import { u as Xt } from "../../chunks/use-input-props.js";
import { g as ie, u as Zt, O as Kt, C as at, F as Ut, P as Ne } from "../../chunks/CloseButton.js";
import { c as ot } from "../../chunks/create-safe-context.js";
import { p as st, I as De } from "../../chunks/Input.js";
import { a as Qt, T as lt, u as Ze } from "../../chunks/Transition.js";
...
var on = typeof window < "u" ? b.useLayoutEffect : b.useEffect, Ke = /* @__PURE__ */ new WeakMap();
function sn(e, t) {
...
var Z = Ee ? { passive: !1 } : !1, Nn = function(e) {
...
function In(e) {
  ...
  b.useEffect(function() {
    return K.push(o), e.setCallbacks({
      onScrollCapture: f,
      onWheelCapture: f,
      onTouchMoveCapture: h
    }), document.addEventListener("wheel", i, Z), document.addEventListener("touchmove", i, Z), document.addEventListener("touchstart", d, Z), function() {
      K = K.filter(function(u) {
        return u !== o;
      }), document.removeEventListener("wheel", i, Z), document.removeEventListener("touchmove", i, Z), document.removeEventListener("touchstart", d, Z);
    };
  }, []);
...
function Zn({
  ...
  return $n(
    ...
    { capture: !0 }
  ), Zt({ opened: n, shouldReturnFocus: r && c }), {
    _id: s,
    titleMounted: i,
    bodyMounted: d,
    shouldLockScroll: p,
...
const Kn = j(
  ({
    ...
    const { _id: y, titleMounted: m, bodyMounted: M, shouldLockScroll: D, setTitleMounted: E, setBodyMounted: V } = Zn({ id: r, transitionProps: a, opened: t, trapFocus: o, closeOnEscape: c, onClose: n, returnFocus: s }), { key: Y, ...P } = w || {};
    return /* @__PURE__ */ v(Kt, { ...d, withinPortal: l, children: /* @__PURE__ */ v(
      jn,
      {
        value: {
          opened: t,
      ...
      lt,
      {
        ...
        children: (i) => /* @__PURE__ */ v(
          "div",
          {
            ...
            children: /* @__PURE__ */ v(Ut, { active: s.opened && s.trapFocus, innerRef: c, children: /* @__PURE__ */ v(
              Le,
              {
                ...o,
                component: "section",
