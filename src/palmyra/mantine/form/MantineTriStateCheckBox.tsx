...
function MantineTriStateCheckBox(props: Omit<TriStateCheckBoxProps & CheckboxProps, 'ref'> & ICheckBoxDefinition & { ref?: Ref<ICheckBoxField> }) {
    ...
    return (<>{!mutateOptions.visible &&
        <FieldDecorator label={getFieldLabel(props)} customContainerClass={props.customContainerClass} colspan={props.colspan}
            ...
            <TriStateCheckBox value={value} error={error.message} {...props as any} />
        </FieldDecorator>}
    </>
    )
}
